...
<html>
    ...
    <title>Welcome to you merchant portal</title>
...
<section class="forms-section">
  <h1 class="section-title">Welcome to Vendo Merchant Portal</h1>
  <div class="forms">
      ...
      <form class="form form-signup" action="signup.php" method="post">
        <fieldset>
          ...
          <div class="input-block">
            ...
            <input id="signup-firstname" type="text" name="firstname" required>
          </div>
          <div class="input-block">
            <label for="signup-lastname">Lastname</label>
            <input id="signup-lastname" type="text" name="lastname" required>
          </div>
          <div class="input-block">
