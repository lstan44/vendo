...
<div class="footer">
	<div class="container">
		<div class="col-md-6 footer-grid">
			<h3>About Us</h3>
			<p>We are an e-commerce platform where you can buy securely online.</p>
		</div>
		...
		<div class="clearfix"></div>
			<div class="footer-bottom">
				<h2 ><a href="index.html">VENDO<span>Find Everything Online</span></a></h2>
				...
				<div class=" address">
					<div class="col-md-4 fo-grid1">
							<p><i class="fa fa-home" aria-hidden="true"></i>New York, NY</p>
					</div>
					<div class="col-md-4 fo-grid1">
							<p><i class="fa fa-phone" aria-hidden="true"></i>347 828-4273</p>	
					</div>
					<div class="col-md-4 fo-grid1">
						<p><a href="mailto:help@vendo.com"><i class="fa fa-envelope-o" aria-hidden="true"></i>help@vendo.com</a></p>
					</div>
					<div class="clearfix"></div>
